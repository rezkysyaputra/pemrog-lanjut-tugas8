    ...
    public partial class Form1 : Form
    {
        ...
        private SQLiteConnection GetOpenConnection()
        {
            ...
            try // penggunaan blok try-catch untuk penanganan error
            {
                ...
                string dbName = @"C:\PEMROGLANJUT\pert8\LatihanADO.NET\Database\DbPerpustakaan.db";
        ...
        private void btnTampilkanData_Click(object sender, EventArgs e)
        {
            ...
            while (dtr.Read()) // gunakan perulangan utk menampilkan data listview
 {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                result = cmd.ExecuteNonQuery();
                MessageBox.Show("Apakah Data mahasiswa ingin Di hapus !", "Konfirmasi",
            ...
            if (result > 0)
            {
                MessageBox.Show("Data mahasiswa berhasil Di hapus !", "Informasi",
               MessageBoxButtons.OK,
                MessageBoxIcon.Information);
                // reset form
                txtNpmDelete.Clear();
